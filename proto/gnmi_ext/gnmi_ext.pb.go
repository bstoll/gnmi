...
func file_github_com_openconfig_gnmi_proto_gnmi_ext_gnmi_ext_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_github_com_openconfig_gnmi_proto_gnmi_ext_gnmi_ext_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*Commit); i {
			case 0:
				return &v.state
			case 1:
		...
		file_github_com_openconfig_gnmi_proto_gnmi_ext_gnmi_ext_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_github_com_openconfig_gnmi_proto_gnmi_ext_gnmi_ext_proto_msgTypes[9].Exporter = func(v any, i int) any {
		...
		file_github_com_openconfig_gnmi_proto_gnmi_ext_gnmi_ext_proto_msgTypes[10].Exporter = func(v any, i int) any {
		...
		file_github_com_openconfig_gnmi_proto_gnmi_ext_gnmi_ext_proto_msgTypes[11].Exporter = func(v any, i int) any {
		...
		file_github_com_openconfig_gnmi_proto_gnmi_ext_gnmi_ext_proto_msgTypes[12].Exporter = func(v any, i int) any {
			switch v := v.(*Depth); i {
			case 0:
				return &v.state
			case 1:
